...
public class GameServiceImpl implements GameService {
    ...
    public Game dtoToEntity(GameDTO game) {
        ...
        CommunicationType communicationType = communicationTypeRepository.findById(game.getCommunicationType().getId())
                .orElseThrow(() -> new IllegalArgumentException("CommunicationType with id " + game.getCommunicationType().getId() + " not found"));
